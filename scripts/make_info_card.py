...
# ===========================================================================
HOST = "conor"   # shown as  conor@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full-Stack Developer @ Daedalus"),
    ("kv", "Loc", "Karlsruhe, Germany"),
    ("kv", "From", "Galway, Ireland"),
    ("kv", "Mail", "fogartyconor3@gmail.com"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "Django, Python, PostgreSQL"),
